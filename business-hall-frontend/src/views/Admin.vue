      ...
      <el-aside width="240px" class="admin-sidebar">
        ...
        >
          <el-menu-item index="/admin/statistics">
            <el-icon class="menu-icon"><i class="el-icon-data-analysis"></i></el-icon>
            <span>数据统计</span>
          </el-menu-item>
          <el-menu-item index="/admin/user">
            <el-icon class="menu-icon"><i class="el-icon-user"></i></el-icon>
            <span>用户管理</span>
          </el-menu-item>
          ...
          <el-menu-item index="/admin/approval">
            <el-icon class="menu-icon"><i class="el-icon-s-check"></i></el-icon>
            <span>审批中心</span>
          </el-menu-item>
        ...
        <el-header class="admin-header">
          <div class="header-content">
            <div class="title-container">
              ...
              <span class="title-subtitle">Admin Panel</span>
            </div>
